...
# (name, desc, buy_time_limit_enabled, buy_time_end)
SCENARIOS = [
    ("B10",  "10:00",  True,  "10:00"),
    ("B11",  "11:00",  True,  "11:00"),
    ("B12",  "12:00 (현재)", True, "12:00"),
    ("B13",  "13:00",  True,  "13:00"),
    ("B14",  "14:00",  True,  "14:00"),
    ("B15",  "15:00",  True,  "15:00"),
    ("Boff", "비활성",  False, "15:20"),
]
...
async def main():
    ...
    for name, desc, enabled, end_time in SCENARIOS:
        d = dict(base_dict)
        d["buy_time_limit_enabled"] = enabled
        d["buy_time_end"] = end_time
