...
# TODO: 키움 0D(호가) 메시지 필드 코드 미확인 — 운영 전 raw 페이로드 캡처 필수.
# 아래 상수는 추정값. 실 로그 수집 후 수정.
_OD_ASK_PRICE_FIELDS  = ("41", "43", "45", "47", "49", "51", "53", "55", "57", "59")  # 매도 1~10호가
_OD_ASK_VOLUME_FIELDS = ("61", "63", "65", "67", "69", "71", "73", "75", "77", "79")  # 매도 1~10잔량
_OD_BID_PRICE_FIELDS  = ("42", "44", "46", "48", "50", "52", "54", "56", "58", "60")  # 매수 1~10호가
_OD_BID_VOLUME_FIELDS = ("62", "64", "66", "68", "70", "72", "74", "76", "78", "80")  # 매수 1~10잔량
